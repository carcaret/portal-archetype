package ${groupId}.aspect;

import ${groupId}.web.listener.ContextHolder;
...
public class LoggingAspect {
    ...
    public void logAfterThrowing(JoinPoint joinPoint, Throwable e) {
        LOG.error("[{}] An exception has been thrown in {}()", ContextHolder.getUUID(), joinPoint
    ...
    public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
        LOG.info("[{}] The method {}() begins with {}", ContextHolder.getUUID(), joinPoint
